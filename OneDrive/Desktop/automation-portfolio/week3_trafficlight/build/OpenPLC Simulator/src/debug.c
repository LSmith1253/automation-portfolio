...
char plc_program_md5[] = "8138d14200484e972f656c9b02402efd";
...
static const struct {
    ...
    {&(RES0__INSTANCE0.AMBER), BOOL_ENUM},
    {&(RES0__INSTANCE0.RED), BOOL_ENUM},
    {&(RES0__INSTANCE0.TIMER1.EN), BOOL_ENUM},
    {&(RES0__INSTANCE0.TIMER1.ENO), BOOL_ENUM},
    {&(RES0__INSTANCE0.TIMER1.IN), BOOL_ENUM},
    {&(RES0__INSTANCE0.TIMER1.PT), TIME_ENUM},
    {&(RES0__INSTANCE0.TIMER1.Q), BOOL_ENUM},
    {&(RES0__INSTANCE0.TIMER1.ET), TIME_ENUM},
    {&(RES0__INSTANCE0.TIMER1.STATE), SINT_ENUM},
    {&(RES0__INSTANCE0.TIMER1.PREV_IN), BOOL_ENUM},
    {&(RES0__INSTANCE0.TIMER1.CURRENT_TIME), TIME_ENUM},
    {&(RES0__INSTANCE0.TIMER1.START_TIME), TIME_ENUM},
    {&(RES0__INSTANCE0.TIMER2.EN), BOOL_ENUM},
    {&(RES0__INSTANCE0.TIMER2.ENO), BOOL_ENUM},
    {&(RES0__INSTANCE0.TIMER2.IN), BOOL_ENUM},
    {&(RES0__INSTANCE0.TIMER2.PT), TIME_ENUM},
    {&(RES0__INSTANCE0.TIMER2.Q), BOOL_ENUM},
    {&(RES0__INSTANCE0.TIMER2.ET), TIME_ENUM},
    {&(RES0__INSTANCE0.TIMER2.STATE), SINT_ENUM},
    {&(RES0__INSTANCE0.TIMER2.PREV_IN), BOOL_ENUM},
    {&(RES0__INSTANCE0.TIMER2.CURRENT_TIME), TIME_ENUM},
    {&(RES0__INSTANCE0.TIMER2.START_TIME), TIME_ENUM},
    {&(RES0__INSTANCE0.TIMER3.EN), BOOL_ENUM},
    {&(RES0__INSTANCE0.TIMER3.ENO), BOOL_ENUM},
    {&(RES0__INSTANCE0.TIMER3.IN), BOOL_ENUM},
    {&(RES0__INSTANCE0.TIMER3.PT), TIME_ENUM},
    {&(RES0__INSTANCE0.TIMER3.Q), BOOL_ENUM},
    {&(RES0__INSTANCE0.TIMER3.ET), TIME_ENUM},
    {&(RES0__INSTANCE0.TIMER3.STATE), SINT_ENUM},
    {&(RES0__INSTANCE0.TIMER3.PREV_IN), BOOL_ENUM},
    {&(RES0__INSTANCE0.TIMER3.CURRENT_TIME), TIME_ENUM},
    {&(RES0__INSTANCE0.TIMER3.START_TIME), TIME_ENUM},
    {&(RES0__INSTANCE0.LIGHTSTEP), INT_ENUM},
};
